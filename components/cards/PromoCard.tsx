...
function PromoCard({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-2 border-border border rounded-xl w-full h-full">
        {/* Image container - fixed square aspect ratio */}
        <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/5 aspect-square shrink-0 rounded-t-xl md:rounded-t-none md:rounded-l-md overflow-hidden">
