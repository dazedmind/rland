    ...
    <>
      ...
      <main>
        <section className="flex flex-col items-start px-8 md:px-16 xl:px-44 justify-center py-16 space-y-8">
          ...
          {/* CTA banner skeleton */}
          <div className="p-8 md:p-12 rounded-xl bg-neutral-200 animate-pulse flex flex-col md:flex-row items-center justify-between gap-8 w-full">
            ...
            <div className="h-12 w-32 bg-neutral-300 rounded-xl animate-pulse shrink-0" />
          </div>
        </section>
      </main>
    </>
