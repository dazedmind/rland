...
function LoanCalculatorPage() {
  ...
  const availableFixingTerms = useMemo(
    () =>
      getAvailableFixingTerms(inputs.paymentType, inputs.loanPaymentTermMonths),
              ...
              <div className="py-12 lg:py-24 text-center lg:text-left flex flex-col gap-8">
                <span className="space-y-4">
                  <h1 className="text-5xl lg:text-6xl font-medium text-white">
                    Loan{" "}
                    <span className="text-secondary font-bold">Calculator</span>
                  </h1>
                  <p className="leading-relaxed text-neutral-200 max-w-xl mx-auto lg:mx-0">
                    Estimate your monthly payments based on your preferred unit
            ...
            <div className="flex flex-col lg:flex-row justify-between w-full gap-16 items-start">
              ...
              <div className="w-full lg:w-3/5 flex flex-col gap-6">
                  ...
                  <header className="hidden flex-col items-center gap-3 border-b border-border bg-neutral-50 px-4 py-5 text-center print:flex print:bg-white print:py-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-neutral-500">
                        rland.ph/loan-calculator · Estimates only; confirm
                        details with our sales team
                      </p>
                    </div>
                  </header>
                  <Table>
                    ...
                    <TableBody>
                      <TableRow className="hover:bg-transparent">
                        <TableCell className="text-sm font-bold text-primary py-2">
                      ...
                      <TableRow className="hover:bg-transparent">
                        <TableCell className="pl-6 text-sm text-neutral-500 py-1 font-medium">
                          Add:
                        </TableCell>
                        <TableCell className="text-right py-1" />
                      </TableRow>
                      <TableRow className="hover:bg-transparent">
                        <TableCell className="pl-6 text-sm text-neutral-400 py-2">
                          Miscellaneous Fees ({MISC_FEES_PERCENTAGE}%)
                        </TableCell>
                      ...
                      <TableRow className="hover:bg-transparent border-b border-border">
                        ...
                        <TableCell className="text-right text-sm text-neutral-400 py-2">
                          {formatCurrency(results.moveInFee)}
                        </TableCell>
                      </TableRow>
                      <TableRow className="hover:bg-transparent">
                      ...
                      <TableRow className="hover:bg-transparent">
                        <TableCell className="text-sm text-neutral-600 py-2">
                          Monthly Down Payment ({inputs.downPaymentTermMonths}{" "}
                          months)
                        </TableCell>
                        <TableCell className="text-right text-sm text-neutral-600 py-2">
                          {formatCurrency(results.monthlyDownPayment)}
                      ...
                      <TableRow className="hover:bg-transparent">
                        <TableCell className="text-sm text-neutral-400 py-2">
                          Rate (per annum)
                        </TableCell>
                        <TableCell className="text-right text-sm text-neutral-400 py-2">
                      ...
                      <TableRow className="hover:bg-primary/90 bg-primary">
                        <TableCell className="text-sm font-bold text-white py-4">
                          Monthly Amortization
                        </TableCell>
                      ...
                      <TableRow className="hover:bg-transparent bg-neutral-50">
                        <TableCell className="text-sm font-semibold text-neutral-600 py-4">
                ...
                <p className="text-xs italic text-neutral-400 leading-relaxed">
                  ...
                  property type, and lender requirements. Please consult with
                  our sales team for accurate quotations.
                </p>
              </div>
            </div>
          </section>
